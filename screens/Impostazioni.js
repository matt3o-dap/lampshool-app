  ...
  return (
    <View style={styles.container}>
        <View style={styles.header}>
          <Text style={{fontSize: responsiveFontSize(26), fontWeight: '700', color: '#5c6cba'}}>Profilo utente</Text>
        </View>
        <View style={styles.tabUtente}>
          ...
          <View style={styles.inlineTabInfo}>
            <Text style={{fontSize: responsiveFontSize(17), fontWeight: '700', color: '#5c6cba'}}>{dataUser.nome}</Text>
            <Text style={{fontSize: responsiveFontSize(13), fontWeight: '700', color: '#9FABFF'}}>{dataUser.classe}</Text>
          </View>
        </View>
        ...
        <View style={styles.tabImpostazioni}>
          {/* <View style={styles.rowImpostazioni}>
            ...
            <Switch trackColor={{ false: "#767577", true: "#81b0ff" }} thumbColor={isEnabled ? "#5c6cba" : "#f4f3f4"} ios_backgroundColor="#575757" onValueChange={toggleSwitch} value={isEnabled}/>
          </View>
          <View style={styles.rowImpostazioni}>
        ...
        <Text style={{fontSize: responsiveFontSize(7),color: "#cfcfcf",fontWeight: "bold",alignSelf: "center",marginTop: 20, marginBottom: 10}}>Made with 💜 by D'Apolito Matteo</Text>
        <Text style={{fontSize: responsiveFontSize(7),color: "#ababab",fontWeight: "bold",alignSelf: "center"}}>LampSchool App - v1.0.0</Text>
    </View>
  );
}
...
const styles =  StyleSheet.create({
  ...
  tabImpostazioni: {
    ...
    width: SCREEN_WIDTH - 50,
    //height: 300,
    paddingBottom: 0, // era 30 con piu opzioni!
